...
interface RadioPickerFieldProps {
  label: string;
  value: Radio | null;
  radios: Radio[];
...
export function RadioPickerField({ label, value, radios, onChange, required }: RadioPickerFieldProps) {
    ...
    <View style={styles.wrap}>
      ...
      <Pressable style={styles.field} onPress={() => { setQuery(''); setOpen(true); }}>
        <Text style={[styles.value, !value && styles.placeholder]} numberOfLines={1}>
          {value ? `${value.modelo || 'Rádio'} (${value.numeroSerie})` : 'Selecionar rádio'}
        </Text>
          ...
          <Pressable style={styles.optionsCard}>
            ...
            <View style={styles.searchBox}>
              ...
              <TextInput
                ...
                placeholder="Buscar nº de série, modelo…"
              ...
              renderItem={({ item }) => (
                ...
                >
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.optionSub}>{item.numeroSerie}</Text>
                  </View>
